...
const pageMeta: PageMeta = {
  home: {
    title: "Mark Santiago",
    description: "Hey, I am Mark Santiago. I'm a Senior Blockchain and Full stack Engineer who enjoys developing innovative software solutions that are tailored to customer desirability and usability.",
    image: myImage,
    keywords: "Mark Santiago's Portfolio, mark's blog, top blog sites, top 10 blog sites, best blog sites, best portfolio template, best programming blogs",
  },
  ...
  stats: {
    ...
    image: myImage,
    keywords: "stats, Statistics, statistics page, marksantiago2909 statistics, this year statistics, github statistics",
  },
  blogs: {
    title: "Blogs",
    ...
    image: blogImage,
    keywords: "numanibnmazid blog, marksantiago2909 blog, blog, webdev, react, react blog application, django blog applicaiton, programming blogs, top 10 programming blogs, top programming blogs",
  },
  certificates: {
    title: "Certificates",
  ...
  about: {
    title: "About",
    description: "Hey, I am Mark Santiago. Experienced professional Software Engineer who enjoys developing innovative software solutions that are tailored to customer desirability and usability.",
    image: myImage,
    keywords: "about, about me, about numan, who is numan, mazid, about mazid, portfolio about page",
  },
  privacy: {
    title: "Privacy Policy",
    description: "At mark-santiago.vercel.app, we value and respect your privacy. This Privacy Policy outlines how we collect, use, and protect your personal information when you visit our website.",
    image: myImage,
    keywords: "Privacy, Privacy Policies, marksantiago2909 privacy policy, numan privacy policy",
  },
  contact: {
    title: "Contact",
    ...
    image: myImage,
    keywords: "contact, contact page, marksantiago2909 contact, contact numan",
  },
  snippets: {
    title: "Snippets",
    description: "These are a collection of snippets I've used in the past and saved. These could be useful to you as well.",
    image: myImage,
    keywords: "Code, Code Snippets, Snippets, marksantiago2909 code snippets, numan code snippets, snippets code, numan snippets, marksantiago2909 snippets",
  },
}
