...
const pageMeta: PageMeta = {
  ...
  stats: {
    ...
    image: myImage,
    keywords: "stats, Statistics, statistics page, marksantiago290 statistics, this year statistics, github statistics",
  },
  blogs: {
    title: "Blogs",
    ...
    image: blogImage,
    keywords: "numanibnmazid blog, marksantiago290 blog, blog, webdev, react, react blog application, django blog applicaiton, programming blogs, top 10 programming blogs, top programming blogs",
  },
  certificates: {
    title: "Certificates",
  ...
  privacy: {
    ...
    image: myImage,
    keywords: "Privacy, Privacy Policies, marksantiago290 privacy policy, numan privacy policy",
  },
  contact: {
    title: "Contact",
    ...
    image: myImage,
    keywords: "contact, contact page, marksantiago290 contact, contact numan",
  },
  snippets: {
    title: "Snippets",
    description: "These are a collection of snippets I've used in the past and saved. These could be useful to you as well.",
    image: myImage,
    keywords: "Code, Code Snippets, Snippets, marksantiago290 code snippets, numan code snippets, snippets code, numan snippets, marksantiago290 snippets",
  },
}
