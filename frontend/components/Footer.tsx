      ...
      >
        <section className="grid grid-cols-3 md:grid-cols-6 gap-10">
          ...
          <div className="flex flex-col gap-4 capitalize">
            ...
            <Link href="https://github.com/marksantiago2909/Mark-Santiago/issues" target="_blank" rel="noopener noreferrer">
        ...
        <motion.div variants={opacityVariant} className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
          <div>
            <p className="order-1 text-base">&copy; {new Date().getFullYear()} Mark Santiago</p>
          </div>
          <div className="text-start md:text-right">
            ...
            <Link
              ...
              aria-label="Next.js"
              rel="noreferrer"
              href="https://t.me/marksantiago2909"
